...
parser = argparse.ArgumentParser(description='Backup folder to Dropbox')
parser.add_argument('folder', nargs='?', default='/undefined',
    ...
    for dn, dirs, files in os.walk(rootdir):
        ...
        for name in files:
            ...
            if name.startswith('.'):
                ...
                if yesno('Upload %s' % name, True, args):
                    upload(dbx, fullname, folder, subfolder, name)
                else:
                    print('#TODO delete file from local')    
...
#def backup():
    #TODO: backup local rootdir to dropbox folder       
